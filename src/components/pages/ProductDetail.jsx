...
import { getProductByCode } from '../../data/productsApi'; // ← API REAL
      ...
      <section className="section container">
        ...
        <div className="detail-grid">
          ...
          <div>
            ...
            <p className="chip">{product.categoria}</p>
            <p className="meta">
              Código: {product.code} • Año: {product.year_released}
            </p>

            <p>{product.description}</p>

            <p className="meta">
              Fabricante: {product.manufacturer} — Distribuidor: {product.distributor}
            </p>
